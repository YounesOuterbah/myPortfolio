    ...
    <div className="landing">
      <div className="container">
        <div
          ...
          } md:w-[90%] md:mx-auto md:mt-12 rounded-2xl md:justify-between p-8 flex flex-col md:flex-row items-center @apply shadow-[rgba(0,0,0,0.18)_0px_2px_4px]`}
        >
          <div className="info text-center md:text-left">
            ...
            <div className="icons flex justify-center mt-2 text-3xl md:justify-normal">
              <a href="https://github.com/YounesOuterbah" target="_blank">
                <AiFillGithub className="cursor-pointer hover:text-red-600 duration-300" />
              </a>
              <a
                ...
                className="ml-3"
              >
                <AiFillLinkedin className="cursor-pointer hover:text-red-600 duration-300" />
              </a>
            </div>
